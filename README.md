...
```text
Windows x86（Intel/AMD 64 位）: localization-workbench-v0.4.5-windows-x64.zip
Windows ARM:                   localization-workbench-v0.4.5-windows-arm64.zip
macOS ARM（Apple Silicon）:    localization-workbench-v0.4.5-macos-arm64.dmg
macOS x86（Intel）:            localization-workbench-v0.4.5-macos-x64.dmg
```
...
- `localization-workbench-v0.4.5-macos-arm64.dmg`: Apple Silicon 推荐安装包.
- `localization-workbench-v0.4.5-macos-x64.dmg`: Intel Mac 推荐安装包.
...
- `localization-workbench-v0.4.5-windows-x64.zip` / `.exe`: Windows x86（Intel/AMD 64 位）推荐下载.
- `localization-workbench-v0.4.5-windows-arm64.zip` / `.exe`: Windows ARM 安装包.
- `localization-workbench-v0.4.5-macos-arm64.dmg`: Apple Silicon 推荐安装包.
- `localization-workbench-v0.4.5-macos-x64.dmg`: Intel Mac 推荐安装包.
- `localization-workbench-v0.4.5-macos-arm64-app.zip` / `-macos-x64-app.zip`: 对应架构的 `.app` 便携包.
